...
from data.config import BIG_TEXT, PERIOD, PROVIDER_TOKEN
...
from keyboard.inline.choice_buttons import start_keyboard, menu_keyboard_halfreg, approval_keyboard, menu_exit_keyboard, \
    menu_keyboard_fullreg, quantity_keyboard, menu_keyboard_subsonly, menu_keyboard_regonly
...
@dp.message_handler(IsPrivate(), regexp=r"^([1][8-9]|[2-9]\d|[1][0-5]\d)$", state=[states.RegMenu.reg_age])
